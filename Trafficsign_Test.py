...
while True:
    ret, original_img = cap.read()     # READ IMAGE
    # PROCESS IMAGE
    ...
    cv2.putText(original_img, "CLASS: ", (20, 35), font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
    cv2.putText(original_img, "PROBABILITY: ", (20, 75), font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
    # PREDICT IMAGE
    ...
    if probabilityValue > threshold:
        ...
        cv2.putText(original_img, str(classIndex) + " " + str(getClassName(classIndex)), (120, 35),
                    font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
        cv2.putText(original_img, str(round(probabilityValue * 100, 2)) + "%", (180, 75),
                    font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
